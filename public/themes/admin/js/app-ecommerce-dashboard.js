    ...
    a = (
        isDarkStyle
            ? ((o = config.colors_dark.cardColor),
              ...
              (i = config.colors_dark.chartBgColor),
              config.colors_dark)
            : ((o = config.colors.cardColor),
              (t = config.colors.textMuted),
              (e = config.colors.headingColor),
              (r = config.colors.borderColor),
              (i = config.colors.chartBgColor),
              config.colors)
    ).bodyColor;
    var n = document.querySelector("#totalProfitChart"),
        l = {
            chart: {
                type: "bar",
                height: 260,
        ...
        n =
            ...
            document.querySelector("#totalSalesDonutChart")),
        l = {
            chart: {
                height: 100,
                width: 110,
                ...
                pie: {
                    donut: {
                        ...
                        labels: {
                            ...
                            name: { offsetY: 18, fontFamily: "Inter" },
                            total: {
                                label: "",
                                label: "1 Quarter",
                                show: !0,
        ...
        l = {
            ...
            grid: {
                ...
                xaxis: { lines: { show: !1 } },
                yaxis: { lines: { show: !1 } },
                padding: { top: -15, left: -7, right: 9, bottom: -15 },
            },
            colors: [config.colors.primary],
            stroke: { width: 5, curve: "smooth" },
            series: [{ data: [13, 30, 20, 35] }],
        ...
        n =
            (null !== n && new ApexCharts(n, l).render(),
            document.querySelector("#totalSalesSemiDonutChart")),
        l = {
            chart: {
                height: 140,
                type: "radialBar",
        ...
        n =
            (null !== n && new ApexCharts(n, l).render(),
            document.querySelector("#newVisitorsChart")),
        l = {
            chart: {
                height: 164,
                type: "bar",
            ...
            legend: { show: !1 },
            dataLabels: { enabled: !1 },
            colors: [s, s, s, s, config.colors.primary, s, s],
            grid: { show: !1, padding: { left: -10, top: -10 } },
            states: {
                hover: { filter: { type: "none" } },
                active: { filter: { type: "none" } },
            },
        ...
        n =
            (null !== n && new ApexCharts(n, l).render(),
            document.querySelector("#webVisitors")),
        l = {
            chart: {
                width: 160,
                parentHeightOffset: 0,
            ...
            responsive: [
                ...
                { breakpoint: 1200, options: { chart: { width: 150 } } },
            ],
        };
    null !== n && new ApexCharts(n, l).render();
})();
