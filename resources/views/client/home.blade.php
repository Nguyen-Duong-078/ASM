            ...
            <div class="row">
                <div class="col-lg-9 mx-auto">
                    ...
                    <ul class="list-inline widget-list-inline">
                        @foreach ($tag as $item)
                            <li class="list-inline-item"><a href="javascript:void">{{ $item->name }}</a></li>
                        @endforeach
                    </ul>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 mb-5">
                    ...
                    <article class="card">
                        <div class="post-slider slider-sm">
                            <img src="{{ Storage::url($topView->image) }}" class="card-img-top" alt="post-thumb">
                        </div>

                        <div class="card-body">
                            <h3 class="h4 mb-3"><a class="post-title"
                                    href="{{ route('new_detail', $topView->id) }}">{{ $topView->title }}</a>
                            </h3>
                            <ul class="card-meta list-inline">
                                <li class="list-inline-item">
                                    <a href="author-single.html" class="card-meta-author">
                                        <img src="{{ asset('themes') }}/client/images/john-doe.jpg">
                                        <span>{{ $topView->author->name }}</span>
                                    </a>
                                </li>
                                <li class="list-inline-item">
                                    <i class="ti-timer"></i>{{ $topView->created_at->diffForHumans() }}
                                </li>
                                <li class="list-inline-item">
                                    <i
                                        class="ti-calendar"></i>{{ optional($topView->created_at)->format('d/m/Y') ?? 'N/A' }}
                                </li>
                                <li class="list-inline-item">
                                    Lượt xem: {{ $topView->view }}
                                </li>
                                <li class="list-inline-item">
                                    <ul class="card-meta-tag list-inline">
                                        @foreach ($topView->tags as $item)
                                            <li class="list-inline-item"><a href="javascript:void">{{ $item->name }}</a>
                                            </li>
                                        @endforeach
                                    </ul>
                                </li>
                            </ul>
                            <p>{{ Str::words($topView->content, 23, '...') }}</p>
                            <a href="{{ route('new_detail', $topView->id) }}" class="btn btn-outline-primary">Đọc
                                thêm</a>
                        </div>
                    </article>
                </div>
                    ...
                    @foreach ($data as $item)
                        <article class="card mb-4">
                            <div class="card-body d-flex">
                                ...
                                <div class="ml-3">
                                    <h4>
                                        <a href="{{ route('new_detail', $item->id) }}"
                                    ...
                                    <ul class="card-meta list-inline mb-0">
                                        <li class="list-inline-item mb-0">
                                            <i class="ti-calendar">
                                            </i>{{ optional($item->created_at)->format('d/m/Y') ?? 'N/A' }}
                                        </li>
                                        <li class="list-inline-item mb-0">
                                            <i class="ti-timer"></i>{{ $item->created_at->diffForHumans() }}
                                        </li>
                                    </ul>
                                </div>
                            </div>
                ...
                <div class="col-lg-4 mb-5">
                    ...
                    <article class="card">
                        <div class="post-slider slider-sm">
                            <img src="{{ Storage::url($popular->image) }}" class="card-img-top" alt="post-thumb">
                        </div>
                        <div class="card-body">
                            <h3 class="h4 mb-3"><a class="post-title"
                                    href="{{ route('client.views.popular', $popular->id) }}">{{ $popular->title }}</a>
                            </h3>
                            <ul class="card-meta list-inline">
                                <li class="list-inline-item">
                                    <a href="author-single.html" class="card-meta-author">
                                        <img src="{{ asset('themes') }}/client/images/kate-stone.jpg" alt="Kate Stone">
                                        <span>{{ $popular->author->name }}</span>
                                    </a>
                                </li>
                                <li class="list-inline-item">
                                    <i class="ti-timer"></i>
                                ...
                                <li class="list-inline-item">
                                    ...
                                    {{ optional($popular->created_at)->format('d/m/Y') ?? 'N/A' }}
                                </li>
                                <li class="list-inline-item">
                                    <ul class="card-meta-tag list-inline">
                                        @foreach ($popular->tags as $item)
                                            <li class="list-inline-item"><a
                                                    href="javascript:void">{{ $item->name }}</a>
                                            </li>
                                        @endforeach
                                    </ul>
                                </li>
                            </ul>
                            <p>{{ Str::words($popular->content, 23, '...') }}
                            </p>
                            <a href="{{ route('client.views.popular', $popular->id) }}"
                        ...
                        <article class="card mb-4">
                            ...
                            <div class="card-body">
                                <h3 class="mb-3"><a class="post-title"
                                        href="{{ route('new_detail', $item->id) }}">{{ $item->title }}</a></h3>
                                <ul class="card-meta list-inline">
                                    <li class="list-inline-item">
                                        <a href="author-single.html" class="card-meta-author">
                                            <img src="{{ asset('themes') }}/client/images/john-doe.jpg">
                                    ...
                                    <li class="list-inline-item">
                                        <i
                                            class="ti-calendar"></i>{{ optional($item->created_at)->format('d/m/Y') ?? 'N/A' }}
                                    </li>
                                    <li class="list-inline-item">
                                        <ul class="card-meta-tag list-inline">
                                            @foreach ($item->tags as $items)
                                                <li class="list-inline-item"><a
                                                        href="javascript:void">{{ $items->name }}</a>
                                                </li>
                                            @endforeach
                                        </ul>
                                    </li>
                                ...
                                <a href="{{ route('new_detail', $item->id) }}" class="btn btn-outline-primary">Xem
                                    thêm</a>
                            </div>
                        </article>
                    @endforeach
