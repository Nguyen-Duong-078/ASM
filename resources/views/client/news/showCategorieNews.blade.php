        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8  mb-5 mb-lg-0">
                    <h1 class="h2 mb-4">Bài viết của thể loại <mark>{{ $categorie->name }}</mark></h1>
                            ...
                            <div class="card-body">
                                ...
                                <ul class="card-meta list-inline">
                                    <li class="list-inline-item">
                                        <a href="javascript:void" class="card-meta-author">
                                        ...
                                        <ul class="card-meta-tag list-inline">
                                            @foreach ($item->tags as $tag)
                                                <li class="list-inline-item"><a
                                                        href="javascript:void">{{ $tag->name }}</a>
                                                </li>
                                            @endforeach
                                        </ul>
                                    </li>
                                ...
                                <a href="{{ route('new_detail', $item->id) }}" class="btn btn-outline-primary">Xem thêm</a>
                            </div>
                        </article>
                    @endforeach
